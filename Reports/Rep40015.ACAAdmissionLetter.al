report 40015 "Admission Letter"
{

    ApplicationArea = All;
    WordLayout = './Reports/SSR/AdmissionLetter.docx';
    ...
    dataset
    {
        dataitem(bAdmLetter; "ACA-Applic. Form Header")
        {
            ...
            column(CompanyAdrees; CompanyInformation.Address)
            {
            }
            ...
            column(CompanyWebsite; CompanyInformation."Address 2")
            {
            }
