...
/// </summary>
page 84521 "ACA-Application Form"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            field("Provisional Admision Reason"; Rec."Provisional Admision Reason")
            {
                ApplicationArea = All;
                Editable = True;
            }
            group("Personal Information")
            {
                ...
                field(Nationality; Rec.Nationality)
                {
                    ...
                    begin
                        ...
                        rec.NationalityName := Rec.GetCountry(Rec.Nationality);
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Are You a Former KTRH Student';
                }

                field("Former KTRH Reg Number"; Rec."Former KTRH Reg Number")
                {
                    ApplicationArea = All;
                }
            ...
            group(Attachments)
            {
                field("High School Certificate"; Rec."High School Certificate")
                {
                    ...
                    begin
                        ...
                        HYPERLINK(ReplaceString(Rec."High School Certificate", 'C:/inetpub/wwwroot/CUEAApplyMVC/Attachments', '\\WIN-GN4CDIJQLEQ\Attachments'));
                    end;
                }
                field("High School Result slip"; Rec."High School Result slip")
                {
                    ...
                    trigger OnAssistEdit()
                    begin
                        HYPERLINK(ReplaceString(Rec."High School Result slip", 'C:/inetpub/wwwroot/CUEAApplyMVC/Attachments', '\\WIN-GN4CDIJQLEQ\Attachments'));
                ...
                field("Under Graduate Certificate"; Rec."Under Graduate Certificate")
                {
                    ...
                    trigger OnAssistEdit()
                    begin
                        HYPERLINK(ReplaceString(Rec."Under Graduate Certificate", 'C:/inetpub/wwwroot/CUEAApplyMVC/Attachments', '\\WIN-GN4CDIJQLEQ\Attachments'));
                ...
                field("Masters Transcript"; Rec."Masters Transcript")
                {
                    ...
                    trigger OnAssistEdit()
                    begin
                        HYPERLINK(ReplaceString(Rec."Masters Transcript", 'C:/inetpub/wwwroot/CUEAApplyMVC/Attachments', '\\WIN-GN4CDIJQLEQ\Attachments'));
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action(provisionalAdm)
            {
                Caption = 'Process As Provisional Admission';
                Image = SendTo;
                Promoted = True;
                ...
                trigger OnAction()
                begin
                    IF CONFIRM('Do you want to Process this as a Provisional Admission Application', TRUE) = FALSE THEN EXIT;
                    Rec."User ID" := UserId;
                    Rec."Application Type" := Rec."Application Type"::Provisional;
            ...
            action(sendApproval)
            {
                ...
                begin
                    ...
                    IF AppSetup.GET() THEN
                        IF CONFIRM('Send This Application to DAB?', TRUE) = FALSE THEN EXIT;
    ...
    var
        ...
        adm: Record "ACA-Applic. Form Header";
...
#pragma warning restore AL0523
    ...
    begin
        ...
        //adm.Reset();
        //adm.SetRange("Application No.", Rec."Application No.");
        //kuccpsImport.SetFilter(Email, '<>%1', '');
        // if adm.Find('-') then begin
        //     repeat

        //         SendMail.Create(adm.Email, EmailSubject, EmailBody);
        ...
        //     //Dialogie.Close();
        // end
        if adm.get(Rec."Application No.") then begin
            SendMail.Create(Rec.Email, EmailSubject, EmailBody);
            emailObj.Send(SendMail);
        end
        else
