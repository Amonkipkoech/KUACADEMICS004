page 40026 "International Applicants"
{
    Caption = 'International Applicants ';
    ...
    SourceTableView = WHERE(Status = FILTER(Open), "Process Application" = filter(false),"international student " = const(true));// "Finance Cleared" = filter(true)
