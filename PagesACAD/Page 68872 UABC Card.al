page 68872 "Application UABC Card"
{
    PageType = Document;
    SourceTable = 61358;
    InsertAllowed = false;
    layout
    {
        area(content)
        {
            ...
            group("Personal Information")
            {
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Are You a Former CUEA Student';
                }

                field("Former CUEA Reg Number"; Rec."Former KTRH Reg Number")
                {
                    ApplicationArea = All;
                }
            ...
            action(sendApproval)
            {
                ...
                begin
                    ...
                    IF AppSetup.GET() THEN
                        IF CONFIRM('Send this to Admission?', TRUE) = FALSE THEN EXIT;
                    ...
                    //Rec."User ID" := USERID;
                    rec."UAB Staff ID" := UserId;
                    Rec."Date of Receipt" := TODAY;
                    Rec."Documents Verified" := Rec."Documents Verified"::Yes;
                    Rec.Status := Rec.Status::"Provisional Admission";
                    Rec."Submission Status" := Rec."Submission Status"::"UAB Ratified";
                    Rec."UAB Approved" := true;
                    Rec."UAB Approval Date" := TODAY();
                    Rec.MODIFY(true);
                    Send();
                    Message('Application Accepted Succeffilly. Please note that the respective student has been notified');
                    //END;
    ...
    begin
        ...
        Clear(mail);
        mail := Rec.Email;
        EmailBody := 'Dear,' + ' ' + rec."First Name" + ' ' + 'Kindly note that your Application' + ' ' + Rec."Application No." + ' ' + 'has been successfully accepted. Please log onto your admission portal to access your admission letter' + 'This Is a system Generated Email. DO NOT REPLY!!';
        EmailSubject := 'SUCCESSFULL APPLICATION';
