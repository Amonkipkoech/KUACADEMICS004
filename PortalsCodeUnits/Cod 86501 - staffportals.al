...
//         FILESPATH_S: Label 'C:\inetpub\wwwroot\CUEASTAFF\Downloads\';
...
//                 if UnitSubjects.Find('-') then begin
//                     //Message += FORMAT(PartTimeClaimLn."Line No.") + '::' + PartTimeClaimLn."Academic Year" + '::' + PartTimeClaimLn."Semester" + '::' + PartTimeClaimLn."Programme Description" + '::' + UnitSubjects.Desription + ' ::' + PartTimeClaimLn."Mode OF Study" + ' ::' + PartTimeClaimLn.Stream + ' ::' + FORMAT(PartTimeClaimLn.Amount) + ':::';
//                 end;
